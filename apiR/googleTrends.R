...
GoogleTrends <- proto(expr={
  ...
  country <- c("South Africa","Germany","Saudi Arabia","Argentina","Australia","Austria","Belgium","Brazil","Canada","Chilia","Colombia","South Corea","Denemark","Egypt","Spain","USA","Finland","France","Greece","Hong Kong","Hongria","India","Indonesia","Israel","Italia","Japon","Kenya","Malaisia","Mexico","Nigeria","Norway","Holland","Philippines","Poland","Portugal","Czech Republic","Roumania","UK","Russia","Singapour","Sweden","Switzerland","Taiwan","Thailand","Turkey","Ukraine","Vietnam")
